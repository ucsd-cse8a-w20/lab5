...
public class SimpleSound{
  ...
  ///////////////////////////// fields ////////////////////////
  public static Vector<Playback> globalPlaybacks = new Vector<Playback>(); 
  ...
  public SimpleSound(int[] samples) {
     ...
     */
    int lengthInFrames = numChannels * samples.length; 
  ...
  {   
    ...
    /*
     ...
     NOTE(joe, Oct 28): WHY DO THIS? It is just _asking_ for races.

     setBuffer(newBuffer);
     setAudioFileFormat(newAFF);
     */
    SimpleSound newSound = new SimpleSound(this);
    newSound.setBuffer(newBuffer);
    newSound.setAudioFileFormat(newAFF);
    if(DEBUG)
    {
     ...
     */
    Playback playback = new Playback(newSound);
    playbacks.add(playback);
    globalPlaybacks.add(playback);
    playback.start();
